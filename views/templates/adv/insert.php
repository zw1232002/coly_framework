  ...
  <div class="marketing">
    ...
    <div class="panel panel-default">
      ...
      <div class="inner_panel">
        <form role="form" action="<?php echo $curModuleBaseUrl?>insert" method="POST">
          <div class="form-group">
            <label for="exampleInputEmail1">广告主名称<strong class="text-danger">*</strong></label>
            <input type="text" class="form-control" id="exampleInputEmail1" name="name" placeholder="请输入广告主名称" required>
          </div>
          <div class="form-group ">
            <label style="display: block;">是否需要通知对方点击<strong class="text-danger">*</strong></label>
            <label><input type="radio" name="need_click_callback" id="optionsRadios1" value="1" checked>是</label>
            <label><input type="radio" name="need_click_callback" id="optionsRadios1" value="0" >否</label>
          </div>
          <div class="form-group">
            <label for="exampleInputEmail1">点击通知地址<strong class="text-danger">*</strong></label>
            <input type="text" class="form-control" id="" name="clickNotifyUrl" placeholder="收到点击时，通知广告主的点击地址">
          </div>
          <div class="form-group">
